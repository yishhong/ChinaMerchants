...
@implementation UIResponder (Empty)
...
//    NSString *text = @"";
//
//    if([self.showViewType integerValue] == 110 ||[self.showViewType integerValue] == -1009){
//        text = @"点击重新加载";
//    }
//    NSLog(@"%zd",[self.showViewType integerValue]);
//    NSMutableParagraphStyle *paragraph = [NSMutableParagraphStyle new];
//    paragraph.lineBreakMode = NSLineBreakByWordWrapping;
//    paragraph.alignment = NSTextAlignmentCenter;
//    
...
//                                    NSForegroundColorAttributeName: JJDBrownColor,
//                                    NSParagraphStyleAttributeName: paragraph};
//    [attributedString addAttributes:subAttributes range:NSMakeRange(0, text.length)];
//    
...
//    if([self.showViewType integerValue]==110){
//        return 64;
//    }
    return -64.0/2.0;
}
